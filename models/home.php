    ...
    background-size: cover;">
                    ...
                    <div class="container">
                        <div class="row justify-content-md-center">
                            <div class="col-xm-12 col-md-offset-1 col-md-8 col-lg-offset-1 col-lg-10 col-xl-offset-1 col-xl-9">
                                <div class="page-title  home text-center">
                                  <span class="heading-page"> Fast'n Loud
                                  </span>
                                    <p class="mt20">Tú página web de motor y más ahora con un estilo más atractivo</p>
                                </div>
                                ...
                                <div class="hexagon-menu clear">
                                    ...
                                    <div class="hexagon-item">
                                        ...
                                        <a href="registro" class="hex-content">
                                            <span class="hex-content-inner">
                                                ...
                                                <span class="title">Registarte</span>
                                            </span>
                                            <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M86.60254037844386 0L173.20508075688772 50L173.20508075688772 150L86.60254037844386 200L0 150L0 50Z" fill="#1e2530"></path></svg>
                                        </a>
                                    </div>
                                    <div class="hexagon-item">
                                        ...
                                        <a href="mailto:trabajo-fast@fastnloud.com?Subject=Presentación%20y%20currículum" target="_blank" class="hex-content" >
                                            <span class="hex-content-inner">
                                                <span class="icon">
